...
use Certificationy\Component\Certification\Dumper\FileTransportInterface;
use Symfony\Component\Filesystem\Filesystem;

class CertificationFileLoader extends CertificationLoader implements FileTransportInterface
{
    /**
     * @var string
     */
    ...
    public function load($certificationName)
    {
        ...
        if(true === $this->exists($filename = $this->getFilePath($this->getFileName()))){
            ...
            if($this->validate($certification)){
                ...
                throw new \Exception('You must return Certificationy\Component\Certification\Model\Certification object');
            }
        }
    }
